...
namespace soludevabp.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update soludevabpDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update soludevabpEfCoreEntityExtensionMappings to extend the IdentityUser entity
